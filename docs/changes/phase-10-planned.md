...
**Status: Done** — Tasks 1–4 **complete** (reviewed where applicable; Task 4 cleanup 20 Jul 2026). Detail: [phase-10-match-sync](phase-10-match-sync.md) · [phase-10-fixtures-ux](phase-10-fixtures-ux.md) · [phase-10-styling](phase-10-styling.md) · [phase-10-cleanup](phase-10-cleanup.md).
...
| 4 | Project cleanup | Scan workspace/solution; remove duplicates and unused code/assets we will never use | **Done** — [detail](phase-10-cleanup.md) |
...
### 4 — Project cleanup (duplicates & unused) **[Done]**

Implemented **20 Jul 2026**. Full inventory and removals: [phase-10-cleanup](phase-10-cleanup.md).
...
| Path | Verdict |
| --- | --- |
| Root `worldcup-client/` | **Deleted** |
| `TestDatabase_backup_*.dump` | **Deleted** |
| Empty `admin/seed` + `admin/reference` | **Deleted** |
| Workspace `docs/` + `WorldCup-System/docs/` | **Kept** (VitePress SoT + git mirror) |
| `WorldCup-System/worldcup-client/` | **Kept** (canonical SPA) |
...
| `p10-cleanup` | **Done** | Stale root client + dump removed; dual docs kept; [detail](phase-10-cleanup.md) |
...
- Real goalscorer identities from FIFA — **moved to [Phase 11](phase-11-planned.md)**
...
- [Phase 10 Task 4 detail](phase-10-cleanup.md)
- [Phase 11 — Real scorers (planned)](phase-11-planned.md)
