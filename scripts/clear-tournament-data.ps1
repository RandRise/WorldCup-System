...
$clearResult = Invoke-RestMethod -Uri "$ApiBaseUrl/Seed/ClearTournamentData" -Method Post -Headers $headers
Write-Host "Tournament data cleared (users kept):"
$clearResult | ConvertTo-Json -Depth 5
